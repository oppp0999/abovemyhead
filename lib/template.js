module.exports = {
    index_HTML:function(title, authStatusUI, st1){
        return `
        <!doctype html>
        <html>
            <head>
                ...
                <style type="text/css">
                    ...
                    .icon1{
                        ...
                        height: 75px;
                        overflow: hidden;
                        content:url("img/over_IMG_1481-1665584846537.png");
                        z-index: auto;
                    }
                    .icon2{
                        position: absolute;
                    ...
                    .st1{opacity:0.3;fill:#DCDDDD;stroke:#FFFFFF;stroke-width:2;stroke-miterlimit:10;}
            ...
            <body>
                <div class="index">
                    <div class="bar">
                        <div class="sigh">${authStatusUI}</div>
                        <div class="icon_bar">
                                <div class="icon1"></div>
                                <div class="icon2"></div>
                                <div class="icon3"></div>
                    ...
                    <div class="row">
                        <div class="rayer_1">
                            <div class="preview">
                                <div id="rayer_1_t1">어느지역...</div>
                                <img id="rayer_1_i1" src="img/test_1.png">
                            </div>
                            <div class="map">  
                                <svg xmlns='http://www.w3.org/2000/svg' id="rayer_2_1" width="450" height="500" x="0px" y="0px" viewBox="0 0 1398.18 1635.59" style="enable-background:new 0 0 1398.18 1635.59;"> 
                                    <g id="제주도"> 
